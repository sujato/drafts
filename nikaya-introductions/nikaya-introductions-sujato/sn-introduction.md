...
In SuttaCentral, the discourses of the Saṁyutta are referenced by _saṁyutta_ and _sutta_. Thus SN 1.1 is the first discourse of the first _saṁyutta_, while SN 56.11 is the eleventh discourse of the fifty-sixth _saṁyutta_. The SuttaCentral system is the same as that used by Bhikkhu Bodhi in his <cite>Connected Discourses of the Buddha</cite> and on Access to Insight.
...
<cite>Path of Purification</cite>, XV.4, translated by Bhikkhu Ñāṇamoḷi.
