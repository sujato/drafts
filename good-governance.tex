...
%PACKAGES%
\usepackage[left=0.7in, width=3.05in, top=0.9in, height=4.93in, papersize={4.25in, 6.87in}]{geometry}
\usepackage{graphicx}
\usepackage{fontspec}
...
{mmmmmmmmmmmmmmmmmmmmmmmm}%THIS SETS THE GLOBAL DEFAULT WIDTH OF CENTERING. IT IS USUALLY DETERMINED LOCALLY, HOWEVER.%
%VERSE%
